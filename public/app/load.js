...
(function (Whamsauce) {
    ...
    var Load = (function () {
        ...
        Load.all = function () {
            ...
            var promise = new Whamsauce.Promise(), results = {}, count = 0, doneCheck = function (url, result) {
                results[url] = result;
                count++;
        ...
        Load.script = function (url) {
            ...
            var script = document.createElement("script"), head = document.getElementsByTagName('head')[0], promise = new Whamsauce.Promise();
            // Create
            script.async = true;
            script.src = url;
        ...
        Load.file = function (url) {
            var request = new XMLHttpRequest(), promise = new Whamsauce.Promise();
        ...
        Load.json = function (url) {
            var promise = new Whamsauce.Promise();
            Load.file(url).then(function (result) {
                if (result.error) {
